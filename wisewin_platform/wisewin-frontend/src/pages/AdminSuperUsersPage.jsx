...
export default function AdminSuperUsersPage() {
  ...
  return (
    <DashboardLayout sidebarItems={sidebarItems} title="Super Users">

      <section className="relative overflow-hidden bg-[#1A237E] rounded-3xl p-10 text-white shadow-[0_30px_60px_rgba(26,35,126,0.3)]">
        <h1 className="text-4xl font-black mb-2">Super Users</h1>
        <p className="opacity-90">High-level system administrators and managers.</p>
      </section>
      ...
      <section className="mt-2 space-y-3">
        {loading ? (
          ...
          <div className="rounded-2xl bg-white p-6 text-[#454652]">No super users found.</div>
        ) : superUsers.map((user) => (
      ...
      {deleteTarget && (
        <Modal title="Delete Super User" onClose={() => setDeleteTarget(null)}>
